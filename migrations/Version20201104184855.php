 ...
 */
final class Version20201104184855 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE compte (id INT AUTO_INCREMENT NOT NULL, email LONGTEXT NOT NULL, motdepasse LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
