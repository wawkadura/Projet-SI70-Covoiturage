 ...
 */
final class Version20201102195858 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE nom nom LONGTEXT NOT NULL, CHANGE prenom prenom LONGTEXT NOT NULL, CHANGE telephone telephone LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE nom nom VARCHAR(50) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, CHANGE prenom prenom VARCHAR(50) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, CHANGE telephone telephone INT NOT NULL');
    }
}
