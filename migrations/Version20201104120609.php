 ...
 */
final class Version20201104120609 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE caracteristiques (id INT AUTO_INCREMENT NOT NULL, id_description_id INT DEFAULT NULL, id_experience_id INT DEFAULT NULL, id_voiture_id INT DEFAULT NULL, id_utilisateur_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_61B5DA1DF8C1DF42 (id_experience_id), UNIQUE INDEX UNIQ_61B5DA1DC6EE5C49 (id_utilisateur_id), UNIQUE INDEX UNIQ_61B5DA1D30F92B6D (id_description_id), UNIQUE INDEX UNIQ_61B5DA1DA40B286D (id_voiture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
